...
-- trigger2
insert into ORAUX values(3,"oral3",5,150,NULL,STR_TO_DATE('2022/10/25','%Y/%m/%d'));
-- sencé retourner le pb car le prof 10 n'est pas capable de faire le cours 150

-- trigger3
insert into ORAUX values(5,"ORAL5",3,100,NULL,STR_TO_DATE('2022/10/20','%Y/%m/%d'));
...
insert into REPSONDAGE values("oui", "maths", "j'aime bien les maths mais j'ai du mal",STR_TO_DATE('2022/10/21','%Y/%m/%d'),1,1,1);
